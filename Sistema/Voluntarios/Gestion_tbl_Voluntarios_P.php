...
if ($datos=$sql->fetch_object()) { 
        $output['data'] .= '<td><a class="boton-eliminar" href="Delete_voluntarios_proyectos.php?ID_Vinculacion_Proy=' . $row['ID_Vinculacion_Proy'] . '"><i class="zmdi zmdi-delete"></i></a></td>';
}
        $output['data'] .= '</tr>';
    }
} else {
